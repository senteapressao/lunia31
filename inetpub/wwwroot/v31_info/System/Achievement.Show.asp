...
<%
	Call Init()
	' request	: characterSerial,achievementHash,isShow
	' response	: nothing
	...
	Dim characterSerial,achievementHash,isShow
	...
	with sphn
		...
		Call .AppendParam("@isShow",adTinyInt,adParamInput,,isShow)
