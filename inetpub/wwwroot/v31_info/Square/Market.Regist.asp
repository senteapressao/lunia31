...
<%
	...
	'			,petName,petLevel,isRare,rareProbability,enchantSerial
	'			,salePrice,expireDate,regDate,showLevel
	'			,maxItemCount
	' response : characterName,marketId
'Teles4499745742362425
	Dim i,j,k
	...
	'Logger2("rowData=> " & BytesToStr(rowData))
	...
	Dim characterName,category,itemType _
		...
		,maxItemCount
	If UBound(parameters)<20 Then Call Error("not enough parameter")
