...
<%
	...
	Dim characterName,oidProduct,nOrderQuantity,oidCoupon_User,characterName_R,strMessage
	...
	If oPublisher.use_money(strUserID,nTotalPrice,TID,oidProduct,nOrderQuantity,strProductName,nSalePrice,"present",strUserID_R) Then
