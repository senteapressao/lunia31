...
<%
	...
	' items : itemHash,bagNumber,positionNumber,stackedCount,itemSerial,instance,itemExpire
	i = 0
	Response.Write SEPARATOR
	Do Until rs2.Eof
		If i>0 Then Response.Write SUBSEPARATOR
		Response.Write rs2(0) & SUBSEPARATOR & rs2(1) & SUBSEPARATOR & rs2(2) & SUBSEPARATOR & rs2(3) &_
				SUBSEPARATOR & rs2(4) & SUBSEPARATOR & rs2(5) & SUBSEPARATOR & FormatDt(rs2(6),"SQL_TM")
		rs2.MoveNext : i=i+1
	Loop
	rs2.Close
	...
	' pets : petSerial,petName,petLevel,petExp,fullValue,isRare,rareProbability,fullRateSum,dtSum,petHash,enchantSerial
	i = 0
	Response.Write SEPARATOR
	set rs = rs.NextRecordset
	Do Until rs.Eof
	...
	' petItems : petSerial,bagNumber,positionNumber,itemHash,stackedCount,itemSerial,instance,itemExpire
	i = 0
	Response.Write SEPARATOR
	set rs = rs.NextRecordset
	Do Until rs.Eof
