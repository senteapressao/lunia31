...
<%
	...
	'			, delete Items(subseparated: bagNumber,positionNumber,isOnBank)
	'			, update Items(subseparated: itemHash,isOnBank,bagNumber,positionNumber,stackedCount,itemSerial,instance)
	...
	'			, update Quickslots(subseparated: hash,position,isSkill,instance)
	...
	'			, update Pets(subseparated: petSerial,petName,petLevel,petExp,fullValue,isRare)	
	'			, delete PetItems(subseparated: petSerial,bagNumber,positionNumber)
	'			, update PetItems(subseparated: petSerial,bagNumber,positionNumber,itemHash,stackedCount,itemSerial,instance)
	'			, delete PetTraining(subseparated: petSerial)
	'			, insert PetTraining(subseparated: petSerial,itemHash,stackedCount,instance,expFactor,startTime,endTime)
	...
	Dim deleteLicenses,updateLicenses _
		...
		,deletePetTraining,insertPetTraining
	Dim callBack
	Dim arr
	...
	If Ubound(arr)>=0 Then
		If ((UBound(arr)+1) Mod 9)<>0 Then
			Call Error("invalid number of item parameter")
		End If

		For i=0 To UBound(arr) Step 9
