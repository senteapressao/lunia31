...
<%
	...
	sql = sql & "	insert	dbo.tblError(characterName,strASP,requestLog,nError,strSP,serverName) VALUES("& SqlQuot(characterName) &","& SqlQuot(Request.ServerVariables("URL")) & ","& SqlQuot(rowData) & ",@nError,@strSP,"&SqlQuot(REQUESTERID)&")"& vbCrLf
	sql = sql & "	goto lblEnd"& vbCrLf
	...
	Next
	'conn.Execute("INSERT INTO dbo.queryLog (characterName, logData, dateOccurred) VALUES (" & SqlQuot(characterName) & ", " & SqlQuot(rowData) & ", GETDATE())")
	conn.Close()
