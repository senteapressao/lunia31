...
<%
	...
	with sph
		...
		Call .AppendParam("@nOrderMethod",adUnsignedTinyInt,adParamInput,,1)
		...
		Call .AppendParam("@strCharacterName",adVarWChar,adParamInput,50,characterName_R)
		Call .AppendParam("@strCharacterName_S",adVarWChar,adParamInput,50,characterName)
