<%
	...
	' Public Method - Begin
	'-------------------------------------
	Public Sub AppendSoapXmlContainer(name,ns)
	...
	Public Sub Connect()
		...
		If blsDebug Then
			...
			'Response.write "InputXml : " & objXML.xml &"<br>"& vbCrLf
			Response.write "InputXml : " & Replace(Replace(objXML.xml,"<","&lt;"),">","&gt;") &"<br>"& vbCrLf
		End If
