...
<%
	...
	If characterName = "Oracle" or characterName = "Teles" Then
		Call Ok(characterName & SEPARATOR & accountName & SEPARATOR & "-1")
	End If
	...
	Dim oidProduct,nOrderQuantity : oidProduct = 1 : nOrderQuantity = 1
