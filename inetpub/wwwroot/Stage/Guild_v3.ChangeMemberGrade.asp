...
<%
	...
	' response : characterName_target,grade_target
	
	Dim i,j,k
	Dim sph,rs,blsResult : blsResult = False

	' preparing request parameters
	Dim guildId,guildMemberId,characterName_target,grade_target
	...
	with sph
		...
		.SPName = "dbo.public_ChangeMemberGrade"
		Call .InitCommand()
		...
		Call .AppendParam("@grade_target",adUnsignedTinyint,adParamInput,,grade_target)		
	...
	Call Ok(characterName_target & SEPARATOR & grade_target)
%>