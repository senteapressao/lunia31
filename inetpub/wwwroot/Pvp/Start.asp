...
<%
	...
	Dim channelName,address,port,minLevel,maxLevel,isBalanced,serverLocation
	...
	with sph
		...
		Call .AppendParam("@serverLocation",adVarWChar,adParamInput,10,serverLocation)
