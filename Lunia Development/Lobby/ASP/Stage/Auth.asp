...
<%
	...
	set rs = rs.NextRecordset
	If Not(rs.Eof) Then
		Response.Write SEPARATOR & rs(0) & SEPARATOR & rs(1) & SEPARATOR & rs(2) & SEPARATOR & FormatDt(rs(3),"SQL_TM") & SEPARATOR & rs(4)
	Else
		Response.Write SEPARATOR & 0 & SEPARATOR & 1 & SEPARATOR & 0 & SEPARATOR & FormatDt("1900-01-01","SQL_TM") & SEPARATOR & 1
	End If
	...
	Do Until rs.Eof
		...
		Response.Write rs(0) & SUBSEPARATOR & rs(1) &_
				SUBSEPARATOR & CInt(rs(2)) & SUBSEPARATOR & rs(3) & SUBSEPARATOR & 1
		rs.MoveNext : i=i+1
	Loop
